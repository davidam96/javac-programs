	...
	public static void main(String[] args) {
	     ...
	     */
	     ...
	     if (numero>=0 && numero<=9) {
	     	...
	     	cifra1=numero/10;    //me baso en que la funcion de Java de división entre Int's da valores enteros
	     	...
	     	cifra1=numero/100;
	     	aux=numero%100;   //establezco un número auxiliar que carge el resto entero del número de 3 cifras (el resto va a ser de 2 cifras al ser valor entero)
	     	cifra2=aux/10;    //además el auxiliar actúa de variable pivotante, de reducción del número original en 1 cifra cada vez
	     	cifra3=aux%10;
